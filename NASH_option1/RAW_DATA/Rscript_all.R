...
rawdata <- read.delim("C:/Users/User/Documents/Computitional Biology/Year5/Pikarsky_Lab/NASH_option1/RAW_DATA/GSE162694_raw_counts.csv", sep=",")
...
# ALL
VlnPlot(FinalData, features = top10, slot = "counts", log = TRUE)
