...
rawdata <- read.delim("C:/Users/User/Documents/Computitional Biology/Year5/Pikarsky_Lab/NASH_option1/RAW_DATA/GSE162694_raw_counts_EGR1.csv", sep=",")
...
FinalData <- FindClusters(FinalData,modularity.fxn = 1,resolution = 0.1,
                          method = "matrix",algorithm = 1,n.start = 10,
                          n.iter = 10,random.seed = 0,group.singletons = TRUE,
                          verbose = TRUE)

head(Idents(FinalData), 143)
RidgePlot(FinalData, features = top10, group.by = 'age_Identity', ncol = 2)
...
# CYP26A1
VlnPlot(object = FinalData, features = 'CYP26A1', group.by = 'fibrosis_Identity')
VlnPlot(object = FinalData, features = 'CYP26A1', group.by = 'nas_Identity')
VlnPlot(object = FinalData, features = 'CYP26A1', group.by = 'age_Identity')

# TRIB1
VlnPlot(object = FinalData, features = 'TRIB1', group.by = 'fibrosis_Identity')
VlnPlot(object = FinalData, features = 'TRIB1', group.by = 'nas_Identity')
VlnPlot(object = FinalData, features = 'TRIB1', group.by = 'age_Identity')

# RHOB
VlnPlot(object = FinalData, features = 'RHOB', group.by = 'fibrosis_Identity')
VlnPlot(object = FinalData, features = 'RHOB', group.by = 'nas_Identity')
VlnPlot(object = FinalData, features = 'RHOB', group.by = 'age_Identity')
