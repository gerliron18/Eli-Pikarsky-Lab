...
rawdata <- read.delim("C:/Users/User/Documents/Computitional Biology/Year5/Pikarsky_Lab/NAFLD_option2/RAW_DATA/EGR1_targets/arranged_before_surgery_EGR1.csv", sep=",")
...
# RABGGTB.3
VlnPlot(object = FinalData, features = 'RABGGTB.3', group.by = 'fibrosis_Identity')
VlnPlot(object = FinalData, features = 'RABGGTB.3', group.by = 'nas_Identity')
VlnPlot(object = FinalData, features = 'RABGGTB.3', group.by = 'age_Identity')
...
# NCAM2
VlnPlot(object = FinalData, features = 'NCAM2', group.by = 'fibrosis_Identity')
VlnPlot(object = FinalData, features = 'NCAM2', group.by = 'nas_Identity')
VlnPlot(object = FinalData, features = 'NCAM2', group.by = 'age_Identity')

# ACSL4
VlnPlot(object = FinalData, features = 'ACSL4', group.by = 'fibrosis_Identity')
VlnPlot(object = FinalData, features = 'ACSL4', group.by = 'nas_Identity')
VlnPlot(object = FinalData, features = 'ACSL4', group.by = 'age_Identity')
...
# GDF15
VlnPlot(object = FinalData, features = 'GDF15', group.by = 'fibrosis_Identity')
VlnPlot(object = FinalData, features = 'GDF15', group.by = 'nas_Identity')
VlnPlot(object = FinalData, features = 'GDF15', group.by = 'age_Identity')
